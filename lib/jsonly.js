...
*/
	...
	var JSONLY = new Class({
		...
		initialize: function(options, next){
			...
			this.refresh(this.options.endpoints);
		},

		refresh: function(endpoints){
			endpoints.forEach(function(endpoint, index){
				load.chain(this.store.bind(this, endpoint));
			}.bind(this));

			load.chain(this.done.bind(this));
			load.next();
		},
		...
		store: function(endpoint){
			...
			console.log('Remote endpoints are all loaded and cached');
